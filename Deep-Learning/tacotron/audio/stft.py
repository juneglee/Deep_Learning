...
class STFT(nn.Module):
    ...
    def transform(self, input_data):
        ...
        # (4, 1, 10000)
        input_data = input_data.view(num_batches, 1, num_samples) # 하나의 빈 차원
        ...
        magniture = torch.sqrt(real_part ** 2 + imag_part ** 2)
        phase = torch.autograd.Variable(torch.atan2(imag_part.data, real_part.data))

        return magniture, phase

if __name__ == '__main__':
    # stft = STFT()
    audio_path = '../data/lj/wavs/LJ001-0001.wav'
