...
#     # text = 'hello'
#     return [_symbol_to_id[c] for c in text]
#
# def sequence_to_text(sequence:List) -> str:
#     text = ''
#     text = text_to_sequence(sequence)
#     return text
#
# def _sequence_to_text(sequence:List) -> str:
#     return ''.join([_id_to_symbol[id] for id in sequence])
#
# if __name__ == '__main__':
#     text = 'hello 3203 world mrday three'
#
#     from text.cleaners import english_cleaners
#     print(text)
#     clean_text = english_cleaners(text)
#     print(clean_text)
#     t2s = text_to_sequence(clean_text, None)
#     print(t2s)
#
